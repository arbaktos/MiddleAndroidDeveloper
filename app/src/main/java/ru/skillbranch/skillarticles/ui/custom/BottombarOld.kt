...
class BottombarOld @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : ConstraintLayout(context, attrs, defStyleAttr), CoordinatorLayout.AttachedBehavior {

    val binding: LayoutBottombarBinding // not in the source code
    ...
    init {
        binding = LayoutBottombarBinding.inflate(LayoutInflater.from(context), this) // not in the source code
